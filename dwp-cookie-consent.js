...
const ourUse = () => {
    ...
    seg += `</p>`;
    seg += `<p>`;
    seg += `For more detailed information about the cookies we use, see our <a href="https://www.gov.uk/help/cookie-details">Cookies page</a>.`;
    seg += `</p>`;
...
const analytics = () => {
    ...
    seg += `We'd like to set Google Analytics cookies to help us to improve our website by collecting and reporting information on how you use it. 
          ...
          For more information on how these cookies work, please see our <a href="https://www.gov.uk/help/cookie-details">Cookies page</a>.`;
    seg += `</p>`;
    seg += `<p>`;
    seg += `For more detailed information about the cookies we use, see our <ahref="https://www.gov.uk/help/cookie-details">Cookies page</a>.`;
    seg += `</p>`;
    seg += `</div>`; // end of inside fact
    seg += `<div class="row">`;
    seg += `<label class="switch">`;
        ...
        const publicfunc = {
            init: () => {
                if (!cookiesAlreadyAccepted()) {
                    if (!initialised) {
                        initialised = true;
                        let html = buildHTML(buildPopupBody());
